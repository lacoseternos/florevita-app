...
// Range fora do horario: ≥ 20:30 OU < 06:30
function _estaForaDoHorario() {
  const min = _minutosManaus();
  return min >= (20*60 + 30) || min < (6*60 + 30);
}
...
function _mostrarModalJustificativa(user) {
  return new Promise((resolve) => {
    ...
    overlay.innerHTML = `
      <div style="background:#fff;border-radius:16px;max-width:520px;width:100%;overflow:hidden;box-shadow:0 30px 80px rgba(0,0,0,.5);animation:fvFadeIn .25s ease-out;">
        ...
        <div style="padding:22px 26px;">
          <div style="font-size:13px;color:#374151;margin-bottom:12px;line-height:1.5;">
            <strong>Justifique o motivo do acesso:</strong><br>
